"""Unit tests for ProcessExecutorAdapter following TDD principles."""
...
class TestProcessExecutorAdapter:
    ...
    def setup_method(self):
        ...
        self.adapter = ProcessExecutorAdapter()
    ...
    def test_process_executor_adapter_stateless(self):
        ...
        # Arrange
        adapter1 = ProcessExecutorAdapter()
        adapter2 = ProcessExecutorAdapter()
